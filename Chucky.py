...
cl = LINETCR.LINE()
cl.login(token="EoseQAcOuFiJH2h3BO0a.2DiRGPwJwremPKwRR2gfEG.y4Z8iZQkl/XqZo81mwlAOl1zOzpkW3W85LrdFUp6YhA=")
#cl.login(token='TOKEN_HERE')
cl.loginResult()
print "Cl-Login Success\n"

#ki = LINETCR.LINE()
#ki.login(token="En0PnwEos7hNP6sXQgm0.71ww/DC65sQw0eHiHfOOua.Gp446OlsDgEfJk9tMIrwxd4JlKsqQvUly9xTyF9R+6k=")
#ki.login(token='TOKEN_HERE')
#ki.loginResult()
#print "Ki-Login Success\n"

#kk = LINETCR.LINE()
#kk.login(token="EnM6mWlFvPgx7ZAaiVd7.nP5fTJc1er4A73zAHWswXW.y6dZIcExElCgvjQ8paoo0eJ+YFmrO4TLWTx8QiEGU/s=")
#kk.login(token='TOKEN_HERE')
#kk.loginResult()
#print "Kk-Login Success\n"

#kc = LINETCR.LINE()
#kc.login(token="En6cUeWBLFEFz1IOD7W5.BzKG8d3b5zEmT7dBoesGHq.68JUC67IFGqSHrTTMU1kGWiN3dsPRULLGPFWJP3gtts=")
#kc.login(token='TOKEN_HERE')
#kc.loginResult()
#print "Kc-Login Success\n"

#kr = LINETCR.LINE()
#kr.login(token="EnxAP102XIB5jz1CVjA5.sj5il6M0ckMsxWWJt/8irq.owsIdEascP465YaLPjV80ZHrnjDuIKYf6f5Pfw9tqqA=")
#kr.login(token='TOKEN_HERE')
#kr.loginResult()
#print "Kr-Login Success\n"

#km = LINETCR.LINE()
#km.login(token="Ensijz4vjYDyiXfgUDy7.3nJ8SaFwGIiQxKI5akXDDW.nlV8j2mpLWBp/RFeRNyJWrnsxoahwjDAtIOhKq8D9MQ=")
...
╚═════════════════════════
"""
tjia="uc9cf626eb815a70d59c8e71f9fda4872"
#----------------------------------------------------------
setMessage ="""
╔═════════════════════════
║              ☆☞ S E T ☜☆
...
Bots=[mid]
Creator="uc9cf626eb815a70d59c8e71f9fda4872"
admin=["uc9cf626eb815a70d59c8e71f9fda4872","udcd8fcb007d682222a5e48b900ac5d77","udcd8fcb007d682222a5e48b900ac5d77"]
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : Andri\nContact Me : 👉 line.me/ti/p/~eclipse.id",    
    "commentOn":True,
    "commentBlack":{},
...
#--------------------------------------------------------
            elif "Siri:ratakan" in msg.text:
              if msg.from_ in Creator:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("siri:ratakan","")
                    gs = cl.getGroup(msg.to)
                    random.choice(KAC).sendText(msg.to,"Eh Bro Ini Room apaan?")
                    random.choice(KAC).sendText(msg.to,"Ratain aja lah\nRoom Ga Berguna..")
                    random.choice(KAC).sendText(msg.to,"Jangan Baper yah Bro;")
                    msg.contentType = 13
                        ...
                        for target in targets:
                          if target in Bots:
                            ...
                            try:
                              ...
                              random.choice(KAC).sendText(msg.to,"Koq Ga Ditangkis Bro?\nLemah Banget Nih Room")
...
#--------------------------------------------------------
            ...
            elif msg.text in ["Kotor on"]:
                wait["kontol"] = True
                cl.sendText(msg.to,"Contact Sudah Aktif")

            elif msg.text in ["Kotor off"]:
                wait["Kontol"] = False
                cl.sendText(msg.to,"Contact Sudah Di Nonaktifkan")
#-------------------------------------------------------
...
#--------------------------------------------------------
            	...
            	if msg.from_ in admin:
                 ...
                 cl.sendMessage(cnt)
		             ...
		             cl.sendText(msg.to,"Khusus Owner Kak/n" +  datetime.now().strftime('%H:%M:%S'))
...
#--------------------------------------------------------
            ...
            elif 'kontol' in msg.text.lower():
                if msg.from_ not in admin:
                  cl.sendText(msg.to,"Eh kakak Jangan Bilang Kotor\n" +  datetime.now().strftime('%H:%M:%S'))
                  time.sleep(0.5)
                  random.choice(KAC).kickoutFromGroup(msg.to,[msg.from_])
                  cl.sendText(msg.to,"Maaf Aku Kick Kak 😡\nBhay 🙏\n" +  datetime.now().strftime('%H:%M:%S'))

            elif 'babi' in msg.text.lower():
                if msg.from_ not in admin:
                  cl.sendText(msg.to,"Eh kakak Jangan Bilang Kotor\n" +  datetime.now().strftime('%H:%M:%S'))
                  time.sleep(0.5)
                  random.choice(KAC).kickoutFromGroup(msg.to,[msg.from_])
            ...
            elif 'kontoll' in msg.text.lower():
                if msg.from_ not in admin:
                  cl.sendText(msg.to,"Eh kakak Jangan Bilang Kotor\n" +  datetime.now().strftime('%H:%M:%S'))
                  time.sleep(0.5)
                  random.choice(KAC).kickoutFromGroup(msg.to,[msg.from_])
...
#--------------------------------------------------------
            elif msg.text in ["Afika"]:
		cl.sendText(msg.to,"Iya kak, kenapa ? aku disini kok \(ˆ▿ˆ)/\n"  +  datetime.now().strftime('%H:%M:%S'))
...
#----------------------------------------------------------
            ...
            elif msg.text.lower() in ["Afika","afika","Bot","bot"]:
                cl.sendText(msg.to,"Apa Manggil~Manggil Afika kak?" +  datetime.now().strftime('%H:%M:%S'))
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.sendImageWithURL(msg.to,"http://dl.profile.line-cdn.net/0hVNSgRtmjCWFuHiU7JNF2NlJbBwwZMA8pFnoVUBtJVwRGKBwwV3FAAh4ZBFJHJh02USgWABxLAlkQ")
